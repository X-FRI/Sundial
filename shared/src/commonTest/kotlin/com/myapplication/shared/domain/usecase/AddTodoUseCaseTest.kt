...
class AddTodoUseCaseTest {
    ...
    @Test
    fun addsTodoToExplicitList() =
        runTest {
            val repo = FakeTodoRepository()
            repo.addList("收件箱", "blue")
            repo.addList("项目", "red")
            val listId =
                repo.listsState.value
                    .first { it.name == "项目" }
                    .id
    ...
    @Test
    fun emptyDbCreatesInboxOnDemand() =
        runTest {
            val repo = FakeTodoRepository()
    ...
    @Test
    fun parentListWinsOverExplicitList() =
        runTest {
            val repo = repoWithInbox()
            repo.addList("项目", "red")
            val listId =
    ...
    @Test
    fun persistenceFailurePropagates() =
        runTest {
            val repo = repoWithInbox()
