        ...
        val todos =
            listOf(
                item(
                    ...
                    completed = false,
                    isTrashed = true,
                    trashedAt = "2026-08-12T09:00:00Z",
                ),
                item(id = 2, title = "active", due = "2026-08-12T10:00:00Z", completed = false),
                item(
                    id = 3,
                    title = "recent",
                    due = "2026-08-12T11:00:00Z",
                    completed = false,
                    isTrashed = true,
                    trashedAt = "2026-08-12T10:00:00Z",
                ),
            )
